      ...
      <div className="navbar w-full bg-slate-200 flex justify-around">
        <div className="lg:hidden">
          <label htmlFor="dropdown-drawer" tabIndex={0}>
            <FaBars className=" text-black text-2xl"></FaBars>
          </label>
        </div>
        ...
        <div className="">
          <div className="dropdown dropdown-end">
            <label tabIndex={-1} className="btn btn-ghost btn-circle avatar">
              <div className="w-10 rounded-full">
                {user?.photoURL ? (
                  <img src={user?.photoURL} alt="USER_phot0" />
                ) : (
                  <FaUserAlt className="text-4xl ml-0.5"></FaUserAlt>
                )}
              </div>
            </label>
          ...
          <RxExit
            className="text-3xl ml-2 text-red-700 hover:scale-125 duration-300 sm:ml-48"
