...
<footer className="footer p-10 bg-base-200 text-base-content">
  <div>
    ...
    <p>Electro Mart Ltd.<br/>Providing reliable services since 2022</p>
    <div className='flex flex-row gap-x-10 mt-4 text-xl'><FaFacebook/> <FaTwitter/> <FaInstagram/> <FaGlobe/></div>
  </div> 
        <div>
        ...
        <div>
            <span className="footer-title">Legal</span>link
