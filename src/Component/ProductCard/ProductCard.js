...
return (
  <div className="card w-48 bg-base-100 shadow-none">
  <figure className="">
  ...
  <input type="radio" name="rating-6" className="mask mask-star-2 bg-orange-400" />
    ...
    <div className="card-actions">
      {/* <button className="btn rounded-full bg-zinc-500 hover:bg-zinc-950 text-white font-bold py-2 px-4">Add to cart</button> */}
